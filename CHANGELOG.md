...
- Fixed op-name collision in `AnthropicBatchesEndpointHandler`: GET `/v1/messages/batches/{id}/results` now produces `batches.results` instead of colliding with `batches.retrieve`
