...
class AnthropicBatchTracingTest : BaseAITracingTest() {
    ...
    /**
     * Verifies that [instrument] (the SDK reflection path via [patchOpenAICompatibleClient]) attaches
     ...
     * [OkHttpClient] instance than the one patched by [patchOpenAICompatibleClient] — the root cause
     * of Scenario 0 (anthropic/batches/invalid_empty_requests span NOT FOUND in the evaluator).
     */
    @Test
