...
fun instrument(client: AnthropicClient) {
    ...
    // patch any OkHttpClient instance not reached by the targeted calls above (e.g. a lazily-
    // initialized batches sub-client whose holder field name is not "originalHttpClient").
