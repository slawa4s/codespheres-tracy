 ...
 *
 * Parses request and response bodies to extract telemetry data including model parameters,
 * messages, tool definitions, tool calls, usage statistics, and media content.
 *
 * See: [Anthropic Messages API](https://docs.claude.com/en/api/messages)
 */
internal class AnthropicMessagesApiEndpointHandler(
    ...
    // streaming is not supported for messages endpoint
