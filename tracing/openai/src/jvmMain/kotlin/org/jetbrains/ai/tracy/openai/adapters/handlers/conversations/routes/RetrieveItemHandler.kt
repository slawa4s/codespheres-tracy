...
/**
 * Handles `GET /conversations/{conversation_id}/items/{item_id}` — retrieve an item.
 */
internal class RetrieveItemHandler : ConversationRouteHandler {
    ...
    override fun handleResponse(span: Span, response: TracyHttpResponse) {
        ...
        span.setAttribute("gen_ai.operation.name", "retrieve_item")
    }
}
