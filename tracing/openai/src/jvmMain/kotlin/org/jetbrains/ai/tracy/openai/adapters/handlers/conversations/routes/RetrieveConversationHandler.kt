...
private const val OPERATION_NAME = "conversations.retrieve"
private val logger = KotlinLogging.logger {}

/**
 * Handles the `GET /conversations/{conversation_id}` endpoint.
 *
 * See [Conversations API Reference](https://platform.openai.com/docs/api-reference/conversations/retrieve)
 */
