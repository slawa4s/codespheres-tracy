...
/**
 * Handles [ConversationsOpenAIApiEndpointHandler.ConversationRoute.ITEMS_DELETE] endpoint:
...
internal class DeleteConversationItemHandler : ConversationRouteHandler {
    ...
    /**
     * Response: { id, deleted_at or created_at, ... }
     */
    override fun handleResponse(span: Span, response: TracyHttpResponse) {
        ...
        val timestamp = body["deleted_at"] ?: body["created_at"]
        timestamp?.let { span.setAttribute("tracy.conversation.created_at", it.jsonPrimitive.content) }
    }
}
