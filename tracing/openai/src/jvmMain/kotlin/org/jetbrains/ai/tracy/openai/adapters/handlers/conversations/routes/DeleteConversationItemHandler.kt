...
/**
 * Handles DELETE /conversations/{id}/items/{item_id} — deletes a specific conversation item.
 *
 * Sets `gen_ai.operation.name = "conversations.items.delete"` on the response span,
