...
/**
 * Handles [ConversationsOpenAIApiEndpointHandler.ConversationRoute.RETRIEVE_ITEM] endpoint:
 * `GET /conversations/{conversation_id}/items/{item_id}`.
 */
internal class RetrieveConversationItemHandler : ConversationRouteHandler {
    override fun handleRequest(span: Span, request: TracyHttpRequest) {
        span.setConversationApiType()
        span.setConversationOperationName("conversations.items.retrieve")
    ...
    /**
     * Response: Conversation item object with id, type, status.
     */
