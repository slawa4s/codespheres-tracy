...
internal object OpenAIApiUtils {
     ...
     *
     * Note: `gen_ai.operation.name` is intentionally not set here. Each [EndpointApiHandler]
     * is responsible for setting a meaningful operation name rather than using the raw JSON
     * `object` field value (e.g. "conversation.deleted"), which does not describe the operation.
     */
