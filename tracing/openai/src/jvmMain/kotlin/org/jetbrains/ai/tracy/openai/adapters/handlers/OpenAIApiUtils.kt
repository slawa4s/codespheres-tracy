...
internal object OpenAIApiUtils {
     ...
     * Each handler must set [io.opentelemetry.semconv.incubating.GenAiIncubatingAttributes.GEN_AI_OPERATION_NAME]
     * explicitly so that per-route values (e.g. "chat") are used rather than the raw "object" field.
     */
