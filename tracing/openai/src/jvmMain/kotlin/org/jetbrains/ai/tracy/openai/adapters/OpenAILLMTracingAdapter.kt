...
private enum class OpenAIApiType(val route: String) {
    ...
    // Must be listed before CHAT_COMPLETIONS so paths like /conversations/{id}/completions
    // are matched here rather than falling through to the chat-completions handler.
