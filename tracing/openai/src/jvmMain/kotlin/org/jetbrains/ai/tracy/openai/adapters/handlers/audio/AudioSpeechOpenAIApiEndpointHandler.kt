 ...
 *
 * Sets `gen_ai.operation.name = "audio.speech"`, `openai.api.type = "audio"`, and
 * `gen_ai.output.type = "speech"` unconditionally. Extracts [GEN_AI_REQUEST_MODEL],
 * `tracy.request.voice`, `tracy.request.response_format`, and `tracy.request.speed`
