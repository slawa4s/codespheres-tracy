...
internal class AudioSpeechOpenAIApiEndpointHandler : EndpointApiHandler {
    ...
    /** Speech API returns binary audio; JSON response body is unavailable without interceptor-level capture. */
    override fun handleResponseAttributes(span: Span, response: TracyHttpResponse) = Unit

    /** Audio speech does not emit SSE events; streaming is not supported for this endpoint. */
