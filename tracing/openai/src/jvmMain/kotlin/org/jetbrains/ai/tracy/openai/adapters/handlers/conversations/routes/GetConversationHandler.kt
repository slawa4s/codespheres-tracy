...
/**
 * Handles the get-conversation endpoint: `GET /realtime/conversations/{conversation_id}`.
 *
 * Response: conversation object → `tracy.conversation.item.*`
 */
internal class GetConversationHandler : ConversationRouteHandler {
    override fun handleRequest(span: Span, request: TracyHttpRequest) {
        ...
        if (conversationId != null) {
            span.setAttribute("tracy.conversation.item.id", conversationId)
        } else {
