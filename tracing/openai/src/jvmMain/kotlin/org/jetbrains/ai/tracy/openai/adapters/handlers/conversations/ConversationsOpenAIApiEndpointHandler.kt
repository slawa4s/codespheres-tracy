...
internal class ConversationsOpenAIApiEndpointHandler : EndpointApiHandler {
    ...
    override fun handleResponseAttributes(span: Span, response: TracyHttpResponse) {
        ...
        // Override GEN_AI_OPERATION_NAME unconditionally: OpenAIApiUtils.setCommonResponseAttributes()
        // (called before this method) maps the response "object" field to GEN_AI_OPERATION_NAME.
        // For the Conversations API that field is "conversation" or "conversation.deleted", neither
        // of which is a valid operation name. This explicit override always wins.
        span.setAttribute(GEN_AI_OPERATION_NAME, route.operationName)
