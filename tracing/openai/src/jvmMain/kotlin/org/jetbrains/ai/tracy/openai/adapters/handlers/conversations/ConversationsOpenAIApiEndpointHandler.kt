 ...
 * 2. `GET /conversations/{conversation_id}` - Retrieve a conversation by ID
 * 3. `POST /conversations/{conversation_id}` or `PATCH /conversations/{conversation_id}` - Update a conversation
...
internal class ConversationsOpenAIApiEndpointHandler : EndpointApiHandler {
    ...
    private enum class ConversationRoute {
        ...
        UPDATE,    // POST or PATCH /conversations/{conversation_id}
