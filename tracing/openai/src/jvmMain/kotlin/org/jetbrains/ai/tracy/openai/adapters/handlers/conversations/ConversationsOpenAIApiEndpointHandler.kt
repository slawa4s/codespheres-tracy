...
internal class ConversationsOpenAIApiEndpointHandler : EndpointApiHandler {
    ...
    private enum class ConversationRoute {
        ...
        ITEMS_CREATE,    // POST /conversations/{conversation_id}/items
        ITEMS_LIST,      // GET /conversations/{conversation_id}/items
        ITEMS_RETRIEVE,  // GET /conversations/{conversation_id}/items/{item_id}
        ITEMS_DELETE,    // DELETE /conversations/{conversation_id}/items/{item_id}
    }
